...
class lob_PPOCatalog(PPOCatalog):
    ...
    def _determine_components_hook(self):
        ...
        # 生成配置
        self._encoder_config = BinCtablEncoderConfig(input_dims=input_dims, ds=ds, ts=ts)
...
if __name__ == "__main__":
    net = BinCtablEncoderConfig(input_dims=(20, 10), ds=(20, 40, 40, 3), ts=(10, 6, 3, 1)).build()
    print(net)

    batch_size = 2
    input_tensor = torch.randn(batch_size, 20, 10)  # PyTorch格式
