...
class trainer(trainer_base):
    ...
    def init_param(self, data_folder=''):
        ...
        y_n = 3
        title = f'binctabl_p{predict_n}_v{idx}_nostop'
        data_parm = {
        ...
        init_param(
            ...
            learning_rate=0.0001, batch_size=64, workers=self.workers, no_better_stop=0,
            ...
            describe='binctabl predict_n=10 no_better_stop=0'
        )
