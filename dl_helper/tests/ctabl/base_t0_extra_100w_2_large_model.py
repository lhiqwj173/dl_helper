...
class test(test_base):
    ...
    @classmethod
    def title_base(cls):
        return 'binctabl_base_t0_extra_100w_2_large_model'
    ...
    def __init__(self, *args, target_type=1, **kwargs):
        ...
        self.para = Params(
            ...
            describe=f'extra 100w 2 large predict_n:{self.predict_n}',
            amp=self.amp
        )
...
if '__main__' == __name__:
    ...
    run(
        ...
        amp='fp16',
        mode='cache_data',
        data_folder=r'/kaggle/input/lh-q-t0-data-extra-100w-2'
    )