...
class test(test_base):
    ...
    def __init__(self, *args, target_type=1, **kwargs):
        ...
        classify_idx, targrt_name = 1 + (predict_n_vars.index(self.predict_n) + 4) * 2 , f'{self.predict_n}_target_mid_diff'
...
if '__main__' == __name__:
    ...
    # ##########################
    # import os, random
    # files = os.listdir(r'Z:\L2_DATA\train_data\20240817\train')
    ...
    run(
        ...
        amp='fp16',
        mode='cache_data',
        data_folder=r'/kaggle/input/lh-q-t0-data-20240817'
    )