...
class test(test_base):
    ...
    @classmethod
    def title_base(cls):
        return 'binctabl_base_t0_filter_extra_plus_100w'
    ...
    def __init__(self, *args, target_type=1, **kwargs):
        ...
        predict_n_vars = [10, 30]
        min_lr_vars = [3.3e-6, 1.1e-6]
        max_lr_vars = [3.5e-3, 3.5e-3]
        ...
        self.para = Params(
            ...
            describe=f'filter extra plus 100w predict_n:{self.predict_n}',
            amp=self.amp
        )

    def get_in_out_shape(self):
        return (1, 146, 100), (1, self.y_n)
    ...
    def get_model(self):
        # T: 100, 140, 60, 1
        # D: 146, 300, 600, 3
        return m_bin_ctabl(300, 146, 100, 140, 600, 60, self.y_n, 1)

    def get_transform(self, device):
        return transform(device, self.para, 103, num_rows=146)
